...
[Signature(VersionIdentifier = "++UE5+Release-5.2")]
public class UE_5_2 : ISignatureList
{
    ...
    public UE_5_2()
    {
        Signatures = new Signatures
        {
            ...
            GetPakOrder = "48 89 5C 24 ?? 48 89 6C 24 ?? 48 89 74 24 ?? 57 48 83 EC 40 48 8B E9 48 8D 4C 24 ??",
            ...
            IsNonPakFilenameAllowed = "48 89 5C 24 ?? 55 56 57 41 56 41 57 48 83 EC 30 48 8B E9",
            ...
            CommandExecutorType = ObjectCommandExecutorType.AddDevEditor,
        };
    }

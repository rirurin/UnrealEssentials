...
[Signature(VersionIdentifier = "++UE4+Release-4.27")]
public class UE_4_27 : ISignatureList
{
    ...
    public UE_4_27()
    {
        Signatures = new Signatures
        {
            ...
            FIOBatch_ReadInternal = "48 89 5C 24 ?? 48 89 74 24 ?? 57 48 83 EC 40 41 0F 10 00",
            // FAsyncLoadingThread2_StartBundleIoRequests = "40 55 57 48 8D 6C 24 ?? 48 81 EC F8 00 00 00",
            FAsyncPackage2_StartLoading = "48 89 5C 24 ?? 48 89 6C 24 ?? 48 89 74 24 ?? 57 48 83 EC 30 48 8B D9 48 8D 4C 24 ??",
            // LoadThreadType = IoStoreLoadingThreadType.UE4,
            StartLoadDelegate = StartLoadingDelegateType.NoArgs,
            GFNamePool = "4C 8D 05 ?? ?? ?? ?? EB ?? 48 8D 0D ?? ?? ?? ?? E8 ?? ?? ?? ?? 4C 8B C0 C6 05 ?? ?? ?? ?? 01 48 8B 45 ??",
            ChunkIdType = TocChunkIdType.Type2,
        };
    }

...
[Signature(VersionIdentifier = "++UE5+Release-5.0")]
public class UE_5_0 : ISignatureList
{
    ...
    public UE_5_0()
    {
        Signatures = new Signatures
        {
            ...
            PakOpenAsyncRead = "48 89 5C 24 ?? 55 56 41 56 48 81 EC 90 00 00 00",
            ...
            FIOBatch_ReadInternal = "48 89 5C 24 ?? 48 89 6C 24 ?? 56 57 41 54 41 56 41 57 48 83 EC 30 48 8B 01 4C 8B F1",
            ...
            ChunkIdType = TocChunkIdType.Type3,
        };
    }
